...
final class PacketBridge {
    ...
    func start() -> Int32 {
        ...
        // Bump per-socket buffers to avoid drops under burst. On Darwin
        // the kernel may clamp these, but asking for 4 MiB usually
        // grants 2 MiB which is plenty for 100 Mbps × 1280 MTU.
